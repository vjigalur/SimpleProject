...
public class TestCase2 {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		cap.setCapability("app",
				"C:\\Users\\vijaykumarj\\eclipse-workspace\\MobileAutomation\\app\\khan-academy-7-3-2.apk");
		...
		driver.findElement(AppiumBy.xpath("//*[@text='Anything is possible!']")).click();
		//driver.findElement(AppiumBy.xpath("(//android.view.ViewGroup[@content-desc=\"Toggle control visibility\"])[2]"))
			//	.click();

		if (driver.findElement(AppiumBy.xpath("//android.view.ViewGroup[@content-desc=\"Pause\"]")).isDisplayed()) {
			driver.findElement(AppiumBy.accessibilityId("Bookmark")).click();
		} else {
			driver.findElement(
					AppiumBy.xpath("(//android.view.ViewGroup[@content-desc=\"Toggle control visibility\"])[2]"))
					.click();
		}

		if (driver.findElement(AppiumBy.id("android:id/button2")).isDisplayed()) {
